...
QBert::FallingQBertState::FallingQBertState(dae::GameObject* qbert, dae::SpriteComp* spriteComp, QBertMoveComp* moveComp, LevelBase* level)
...
void QBert::FallingQBertState::OnEnter()
{
	...
	dae::ServiceLocator::GetSoundSystem().Play(dae::SoundId(Sound::QBertFall));
}
