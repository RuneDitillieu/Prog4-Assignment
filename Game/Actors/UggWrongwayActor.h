...
namespace QBert
{
    ...
    class UggWrongwayActor final : public dae::Component, dae::IObserver
    {
    public:
        UggWrongwayActor(dae::GameObject* pOwner, LevelBase* pLevel, QBertMoveComp* qbertMove, bool goesRight);
        ~UggWrongwayActor();
